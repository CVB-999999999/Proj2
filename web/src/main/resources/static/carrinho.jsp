				...
				<form class="needs-validation" novalidate>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<small class="text-muted">Nome do Cartão de multibanco</small>
							<div class="invalid-feedback">
								Nome do Cartão é exigido
							</div>
						</div>
						<div class="col-md-6 mb-3">
							<label for="cc-number">Número de cartão</label>
							<input type="text" class="form-control" id="cc-number" placeholder="Número do Cartão" required>
							<div class="invalid-feedback">
								Número de Cartão é obrigatório
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-3 mb-3">
							...
							<input type="text" class="form-control" id="cc-expiration" placeholder="Data de Expiração" required>
							<div class="invalid-feedback">
								Data de Expiração
							</div>
						</div>
...
<script>
	function mostraPop() {
		Swal.fire({
			icon: 'success',
			title: 'Obrigado',
			text: 'Obrigado por adquirir a sua refição connosco!',
